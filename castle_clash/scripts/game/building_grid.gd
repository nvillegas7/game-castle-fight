...
func _draw_grid_lines() -> void:
	# KR-style subtle grid on grass
	var grid_color := Color(0.2, 0.35, 0.1, 0.2) if player_index == 0 else Color(0.35, 0.2, 0.1, 0.2)
	...
	# Team-colored border
	var border_col := Color(0.2, 0.4, 0.12, 0.45) if player_index == 0 else Color(0.4, 0.2, 0.12, 0.45)
...
func _draw_occupied_cells() -> void:
	...
	var occupied_color := Color(0.25, 0.4, 0.15, 0.25) if player_index == 0 else Color(0.4, 0.25, 0.15, 0.25)
